...
from pyti.money_flow import money_flow as indicator


# params: period
# https://github.com/kylejusticemagnuson/pyti/blob/master/pyti/money_flow.py
class PytiMoneyFlow(GenericIndicator):
